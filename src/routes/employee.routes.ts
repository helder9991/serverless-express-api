...
import DeleteEmployeeController from '../modules/employee/controllers/DeleteEmployeeController'
...
routes.delete('/:id', (req: Request, res: Response) => DeleteEmployeeController.handle(req, res))
